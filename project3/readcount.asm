...
_readcount:     file format elf32-i386
...
int main(int argc, char *argv[]){
  ...
  25:	be 20 08 00 00       	mov    $0x820,%esi
int main(int argc, char *argv[]){
	if(argc < 2){
    		printf(1, "Too few arguments.\n");
    		exit();
  ...
  2f:	89 c3                	mov    %eax,%ebx
	const char *calls[] = {
  31:	b9 17 00 00 00       	mov    $0x17,%ecx
  36:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
		"mkdir",
		"close",
		"readcount",
		"countreset"
  ...
  3b:	e8 12 03 00 00       	call   352 <getreadcount>
  40:	50                   	push   %eax
  41:	ff 74 9d 88          	pushl  -0x78(%ebp,%ebx,4)
...
int main(int argc, char *argv[]){
  ...
  59:	50                   	push   %eax
  5a:	50                   	push   %eax
  5b:	68 40 07 00 00       	push   $0x740
  60:	6a 01                	push   $0x1
  62:	e8 a9 03 00 00       	call   410 <printf>
    		exit();
  67:	e8 46 02 00 00       	call   2b2 <exit>
  6c:	66 90                	xchg   %ax,%ax
  6e:	66 90                	xchg   %ax,%ax
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3af:	f7 f6                	div    %esi
 3b1:	0f b6 92 84 08 00 00 	movzbl 0x884(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 528:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 52b:	b8 7c 08 00 00       	mov    $0x87c,%eax
...
free(void *ap)
{
 ...
 5b1:	a1 28 0b 00 00       	mov    0xb28,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 607:	89 08                	mov    %ecx,(%eax)
  freep = p;
 609:	a3 28 0b 00 00       	mov    %eax,0xb28
}
 60e:	5b                   	pop    %ebx
 60f:	5e                   	pop    %esi
 610:	5f                   	pop    %edi
 ...
 62a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 62d:	a3 28 0b 00 00       	mov    %eax,0xb28
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 649:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 64c:	8b 15 28 0b 00 00    	mov    0xb28,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 69f:	76 3f                	jbe    6e0 <malloc+0xa0>
    ...
    if(p == freep)
 6a1:	39 05 28 0b 00 00    	cmp    %eax,0xb28
 ...
 6c6:	e8 e5 fe ff ff       	call   5b0 <free>
  return freep;
 6cb:	8b 15 28 0b 00 00    	mov    0xb28,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 6ec:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 6ef:	89 15 28 0b 00 00    	mov    %edx,0xb28
      return (void*)(p + 1);
 ...
 704:	eb e9                	jmp    6ef <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 706:	c7 05 28 0b 00 00 2c 	movl   $0xb2c,0xb28
 70d:	0b 00 00 
 710:	c7 05 2c 0b 00 00 2c 	movl   $0xb2c,0xb2c
 717:	0b 00 00 
    base.s.size = 0;
 71a:	b8 2c 0b 00 00       	mov    $0xb2c,%eax
 71f:	c7 05 30 0b 00 00 00 	movl   $0x0,0xb30
 726:	00 00 00 
