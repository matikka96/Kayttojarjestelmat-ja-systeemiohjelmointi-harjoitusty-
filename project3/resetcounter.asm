...
int main(int argc, char *argv[]){
   ...
   f:	53                   	push   %ebx
  10:	51                   	push   %ecx
  11:	83 ec 74             	sub    $0x74,%esp
  14:	8b 41 04             	mov    0x4(%ecx),%eax
  17:	8b 31                	mov    (%ecx),%esi
	int input = atoi(argv[1]);
  19:	ff 70 04             	pushl  0x4(%eax)
  1c:	e8 5f 02 00 00       	call   280 <atoi>
	if(argc < 2){
  21:	83 c4 10             	add    $0x10,%esp
  24:	83 fe 01             	cmp    $0x1,%esi
  27:	7e 40                	jle    69 <main+0x69>
		"mkdir",
		"close",
		"readcount",
		"countreset"
  ...
  29:	83 ec 0c             	sub    $0xc,%esp
	...
	const char *calls[] = {
  2c:	8d 7d 8c             	lea    -0x74(%ebp),%edi
  2f:	be 60 08 00 00       	mov    $0x860,%esi
  34:	b9 17 00 00 00       	mov    $0x17,%ecx
  39:	89 c3                	mov    %eax,%ebx
  3b:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
		"mkdir",
		"close",
		"readcount",
		"countreset"
	...
	if(countreset(input) == 0) {
  3d:	50                   	push   %eax
  3e:	e8 57 03 00 00       	call   39a <countreset>
  43:	83 c4 10             	add    $0x10,%esp
  46:	85 c0                	test   %eax,%eax
  48:	74 45                	je     8f <main+0x8f>
		printf(1, "System call %s counter reset\n", calls[input-1]);
		exit();
	} else if(countreset(input) == 1) {
  4a:	83 ec 0c             	sub    $0xc,%esp
  4d:	53                   	push   %ebx
  4e:	e8 47 03 00 00       	call   39a <countreset>
  53:	83 c4 10             	add    $0x10,%esp
  56:	83 f8 01             	cmp    $0x1,%eax
  59:	74 21                	je     7c <main+0x7c>
...
int main(int argc, char *argv[]){
  ...
  69:	51                   	push   %ecx
  6a:	51                   	push   %ecx
  6b:	68 80 07 00 00       	push   $0x780
  70:	6a 01                	push   $0x1
  72:	e8 d9 03 00 00       	call   450 <printf>
    		exit();
  77:	e8 76 02 00 00       	call   2f2 <exit>
	};
	if(countreset(input) == 0) {
		printf(1, "System call %s counter reset\n", calls[input-1]);
		exit();
  ...
  8a:	e8 63 02 00 00       	call   2f2 <exit>
	...
	if(countreset(input) == 0) {
		printf(1, "System call %s counter reset\n", calls[input-1]);
  8f:	52                   	push   %edx
  90:	ff 74 9d 88          	pushl  -0x78(%ebp,%ebx,4)
  94:	68 94 07 00 00       	push   $0x794
  99:	6a 01                	push   $0x1
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3ef:	f7 f6                	div    %esi
 3f1:	0f b6 92 c4 08 00 00 	movzbl 0x8c4(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 568:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 56b:	b8 bc 08 00 00       	mov    $0x8bc,%eax
...
free(void *ap)
{
 ...
 5f1:	a1 80 0b 00 00       	mov    0xb80,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 647:	89 08                	mov    %ecx,(%eax)
  freep = p;
 649:	a3 80 0b 00 00       	mov    %eax,0xb80
}
 64e:	5b                   	pop    %ebx
 64f:	5e                   	pop    %esi
 650:	5f                   	pop    %edi
 ...
 66a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 66d:	a3 80 0b 00 00       	mov    %eax,0xb80
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 689:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 68c:	8b 15 80 0b 00 00    	mov    0xb80,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 6df:	76 3f                	jbe    720 <malloc+0xa0>
    ...
    if(p == freep)
 6e1:	39 05 80 0b 00 00    	cmp    %eax,0xb80
 ...
 706:	e8 e5 fe ff ff       	call   5f0 <free>
  return freep;
 70b:	8b 15 80 0b 00 00    	mov    0xb80,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 72c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 72f:	89 15 80 0b 00 00    	mov    %edx,0xb80
      return (void*)(p + 1);
 ...
 744:	eb e9                	jmp    72f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 746:	c7 05 80 0b 00 00 84 	movl   $0xb84,0xb80
 74d:	0b 00 00 
 750:	c7 05 84 0b 00 00 84 	movl   $0xb84,0xb84
 757:	0b 00 00 
    base.s.size = 0;
 75a:	b8 84 0b 00 00       	mov    $0xb84,%eax
 75f:	c7 05 88 0b 00 00 00 	movl   $0x0,0xb88
 766:	00 00 00 
